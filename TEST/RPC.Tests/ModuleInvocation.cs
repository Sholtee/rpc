...
namespace Solti.Utils.Rpc.Tests
{
    ...
    public class ModuleInvocationTests
    {
        ...
        public async Task ModuleInvocation_ShouldQueryTheService() 
        {
            ...
            await Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, nameof(IService), nameof(IService.Add), null, AsStream(1, 2), default));
        ...
        public async Task ModuleInvocation_ShouldCallTheDesiredMethod() 
        {
            ...
            Assert.That(await Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, nameof(IService), nameof(IService.Add), null, AsStream(1, 2), default)), Is.EqualTo(3));
        ...
        public void ModuleInvocation_ShouldThrowIfTheModuleNotFound() 
        {
            ...
            Assert.ThrowsAsync<MissingModuleException>(() => Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, "Invalid", nameof(IService.Add), null, AsStream(1, 2), default)));
        }
        ...
        public void ModuleInvocation_ShouldThrowIfTheMethodNotFound() 
        {
            ...
            Assert.ThrowsAsync<MissingMethodException>(() => Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, nameof(IService), "Invalid", null, null, default)));
        }
        ...
        public void ModuleInvocation_ShouldThrowOnInvalidParameter(Stream payload) 
        {
            ...
            Assert.ThrowsAsync<JsonException>(() => Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, nameof(IService), nameof(IService.Add), null, payload, default)));
        }
        ...
        public async Task ModuleInvocation_ShouldWorkWithVoidMethods() 
        {
            ...
            Assert.IsNull(await Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, nameof(IService), nameof(IService.Void), null, AsStream(), default)));
        ...
        public void ModuleInvocation_ShouldHandleMethodAlias()
        {
            ...
            Assert.ThrowsAsync<MissingMethodException>(() => Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, nameof(IService), nameof(IService.Bar), null, AsStream(), default)));
            Assert.DoesNotThrowAsync(() => Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, nameof(IService), "Cica", null, AsStream(), default)));
        }
        ...
        public void ModuleInvocation_ShouldTakeIgnoreAttributeIntoAccount() 
        {
            ...
            Assert.ThrowsAsync<MissingMethodException>(() => Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, nameof(IService), nameof(IService.Ignored), null, AsStream(), default)));
        }
        ...
        public async Task ModuleInvocation_ShouldHandleTasks() 
        {
            ...
            Assert.That(await Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, nameof(IService), nameof(IService.Async), null, AsStream(), default)), Is.Null);
        ...
        public async Task ModuleInvocation_ShouldHandleTasksHavingRetVal()
        {
            ...
            Assert.That(await Invocation.Invoke(mockInjector.Object, new RpcRequestContext(null, nameof(IService), nameof(IService.AsyncHavingRetVal), null, AsStream(), default)), Is.EqualTo(1));
